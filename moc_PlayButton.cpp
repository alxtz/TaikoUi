...
QT_MOC_LITERAL(1, 11, 7), // "getPlay"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "PlayButton\0getPlay\0"
};
...
void PlayButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PlayButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayButton::getPlay)) {
                *result = 0;
                return;
            }
        }
...
void *PlayButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< PlayButton*>(this));
